...
public class ListEtudiantActivity extends AppCompatActivity {
    ...
    private String loadUrl = "http://10.0.2.2/android/ws/loadEtudiant.php";
    private String loadUrldelete = "http://10.0.2.2/android/ws/delete.php";
    private String updateUrl="http://10.0.2.2/android/ws/updateetudiant.php";
    ...
    private void showModifyDialog(final Etudiant etudiant) {
        ...
        currentDialogImageView=dialogView.findViewById(R.id.imageViewPhotodialog);
        final RadioGroup radioGroupSexe = dialogView.findViewById(R.id.radioGroupSexe);
        final ImageButton btnupadtepic=dialogView.findViewById(R.id.buttonChangePhoto);
        btnupadtepic.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (etudiant.getImage() != null && !etudiant.getImage().isEmpty()) {
            Glide.with(dialogView.getContext())
                    .load("http://10.0.2.2/android/"+etudiant.getImage())
                    .placeholder(R.drawable.baseline_account_circle_24)
                    .error(R.drawable.baseline_account_circle_24)
                    .into(currentDialogImageView);
        } else {
            currentDialogImageView.setImageResource(R.drawable.baseline_account_circle_24);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode==999){
            if(grantResults.length>0 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(ListEtudiantActivity.this,"Error add image",Toast.LENGTH_LONG).show();
            }
            return;
        }
